...
const RenditionFlags RE_ROUNDCORNERS_MASK          = (31 << 16);
...
const RenditionFlags RE_ROUNDCORNERS_OVERLAP_NONE  = (0 << 4);
const RenditionFlags RE_ROUNDCORNERS_OVERLAP_ROUND = (1 << 4);
